...
if change == 1:
    ...
    length_dict = \
        {
            ...
            12 : "Feet to Inches",
            13 : "square-feet to square-meter ",
            14 : "square-feet to Hectre",
            15 : "square-feet to Acres",
        }   
    ...
    for keys, values in length_dict.items():
        print("{:2}. {}".format(keys, values))
    length_convert = int(input("\nWhich conversion you want to do from 1 to 15: "))
    ...
    if length_convert == 1:
        ...
        print("{} Centimeter is equal to {} Feets".format(length_value, length_value /30.48))
    elif length_convert == 12:
        print("{} Feet is equal to {} inches".format(length_value, length_value * 12))
    elif length_convert == 13:
        print("{} square-feet is equal to {} Square-meters".format(length_value, length_value /10.764))
    elif length_convert == 14:
        print("{} square-feet is equal to {} hectres ".format(length_value, length_value /107600))
    elif length_convert == 15:
        print("{} square-feet is equal to {} Acres".format(length_value, length_value /43560))
    else:
        print("Sorry, Please type correct number from 1 to 15.")
